                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <div class="custom-control custom-radio custom-control-inline">
                            ...
                            <label class="custom-control-label" for="customRadioInline1">Server KC/KCS</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="customRadioInline2" name="customRadioInline1" class="custom-control-input" onclick="showKCP();">
                            <label class="custom-control-label" for="customRadioInline2">Server KCP/KCPS</label>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="<?= base_url('/serverbranch/save') ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field() ?>
