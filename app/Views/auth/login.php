        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        <img src="<?= base_url('img/ies_icon.png') ?>" alt="logo" width="80" class="mb-5 mt-2">
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom" data-background="<?= base_url('img/login_bg.jpg') ?>">
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            <div class="pb-3">
                                <h1 class="mb-2 display-4 font-weight-bold">Ruang Server</h1>
                                <h5 class="font-weight-normal text-muted-transparent">Bank BTN</h5>
