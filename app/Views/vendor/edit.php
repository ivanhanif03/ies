                        ...
                        <form action="<?= base_url('vendor/update') . '/' . $vendor['id']; ?>" method="post">
                            ...
                            <div class="row mb-3">
                                <div class="form-group col-12">
                                    ...
                                    <textarea id="scope_work" class="form-control <?php if (session('errors.scope_work')) : ?>is-invalid<?php endif ?>" name="scope_work" placeholder="Masukkan scope of work" rows="5" style="height:100%;"><?= $vendor['scope_work']; ?></textarea>
                                    <div class="invalid-feedback">
