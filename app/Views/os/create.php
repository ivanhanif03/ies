                        ...
                        <form action="<?= base_url('/os/save') ?>" method="post">
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    ...
                                    <input id="nama_os" type="text" class="form-control <?php if (session('errors.nama_os')) : ?>is-invalid<?php endif ?>" name="nama_os" value="<?= old('nama_os') ?>" placeholder="Masukkan nama os" autofocus>
