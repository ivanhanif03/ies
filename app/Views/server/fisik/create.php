                        ...
                        <form action="<?= base_url('/serverfisik/save') ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-2 col-sm-12">
                                    ...
                                    <input id="logical_processor" type="text" class="form-control <?php if (session('errors.logical_processor')) : ?>is-invalid<?php endif ?>" name="logical_processor" value="<?= old('logical_processor') ?>" placeholder="Masukkan logical processor" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');">
                                    <div class="invalid-feedback">
