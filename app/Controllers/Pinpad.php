...
class Pinpad extends BaseController
{
    protected $PinpadModel;

    public function __construct()
    {
        $this->PinpadModel = new PinpadModel();
    }
    ...
    public function index()
    {
        $data = [
            ...
            'rak' => $this->PinpadModel->getPinpad()
        ];
    ...
    public function detail($id)
    {
        $data = [
            'title' => 'Detail Rak',
            'menu' => 'rak',
            'rak' => $this->PinpadModel->getPinpad($id),
            'server_fisik' => $this->PinpadModel->getServerFisik($id),
            'fisik' => $this->PinpadModel->getOneServerFisik($id)
        ];
        // dd($data);
